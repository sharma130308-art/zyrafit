...
import { X, Zap, ZapOff, RotateCcw, ScanBarcode, Keyboard } from "lucide-react";
...
function BarcodeScanner({ open, onClose, onScan }) {
  ...
  const startScanner = useCallback(async () => {
    ...
    try {
      ...
      const boxHeight = Math.min(Math.floor(viewportHeight * 0.3), 200);
      await scanner.start(
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      exit: { opacity: 0 },
      children: [
        /* @__PURE__ */ jsx("div", { ref: scannerRef, className: "absolute inset-0 overflow-hidden", children: /* @__PURE__ */ jsx("style", { children: `
            ...
            ` }) }),
        /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 pointer-events-none flex flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-5 pt-14 pb-4 pointer-events-auto", children: [
            /* @__PURE__ */ jsx(
              motion.button,
              {
                whileTap: { scale: 0.9 },
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-base font-semibold text-background", children: "Scan Barcode" }),
            /* @__PURE__ */ jsx(
              motion.button,
              {
                whileTap: { scale: 0.9 },
                onClick: toggleFlash,
                className: "w-10 h-10 rounded-full bg-foreground/40 backdrop-blur-md flex items-center justify-center",
                children: flashOn ? /* @__PURE__ */ jsx(Zap, { className: "w-5 h-5 text-yellow-400" }) : /* @__PURE__ */ jsx(ZapOff, { className: "w-5 h-5 text-background" })
              }
            )
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("div", { className: "w-72 h-44 relative", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-8 h-8 border-t-3 border-l-3 border-primary rounded-tl-lg" }),
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-8 h-8 border-t-3 border-r-3 border-primary rounded-tr-lg" }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-8 h-8 border-b-3 border-l-3 border-primary rounded-bl-lg" }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 w-8 h-8 border-b-3 border-r-3 border-primary rounded-br-lg" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "px-6 pb-12 pointer-events-auto space-y-3", children: [
            error ? /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("p", { className: "text-destructive-foreground text-sm font-medium flex-1", children: error }),
                  /* @__PURE__ */ jsxs(
                    motion.button,
                    {
                      whileTap: { scale: 0.9 },
            ...
            ) : /* @__PURE__ */ jsxs("div", { className: "bg-foreground/40 backdrop-blur-md rounded-2xl p-4 flex items-center gap-3", children: [
              /* @__PURE__ */ jsx(ScanBarcode, { className: "w-6 h-6 text-background flex-shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-background text-sm font-medium", children: "Point camera at a barcode" }),
                /* @__PURE__ */ jsx("p", { className: "text-background/60 text-xs mt-0.5", children: "EAN, UPC, and other formats supported" })
              ] })
            ] }),
            showManualInput ? /* @__PURE__ */ jsxs(
              motion.div,
              {
                initial: { opacity: 0, y: 10 },
                animate: { opacity: 1, y: 0 },
                ...
                children: [
                  /* @__PURE__ */ jsx("p", { className: "text-background text-sm font-medium mb-2", children: "Enter barcode manually" }),
              ...
              motion.button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(Keyboard, { className: "w-4 h-4 text-background/70" }),
                  /* @__PURE__ */ jsx("span", { className: "text-background/70 text-sm font-medium", children: "Enter barcode manually" })
                ]
              }
            )
          ] })
