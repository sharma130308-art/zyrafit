...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "CalTrack" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "CalTrack" },
      { name: "theme-color", content: "#2d8a4e" },
      { property: "og:title", content: "CalTrack — Daily Calorie & Macro Tracker" },
      { property: "og:description", content: "Track your daily calories and macros with AI-powered food recognition." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "CalTrack — Daily Calorie & Macro Tracker" },
